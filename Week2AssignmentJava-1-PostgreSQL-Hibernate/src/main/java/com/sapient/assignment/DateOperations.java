...
public class DateOperations {
	public static Calendar addDates(Calendar date1,Calendar date2,OperationTable row) {
		row.setType("Addition Of Two Dates");
	...
	public static String substractDates(Calendar date1,Calendar date2,OperationTable row) {
		row.setType("Substraction Of Two Dates");
